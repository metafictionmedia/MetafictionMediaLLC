...
experiences.
          ...
          <div className="mb-8">
            <h3 className={`text-2xl font-bold mb-4 ${themeClasses.text}`}>Featured Book: Jeffree the Monster</h3>
            <p className={`text-lg mb-4 ${themeClasses.text} opacity-90`}>
              Follow Jeffree, a lovable purple monster, as he navigates the challenges of middle school, 
              friendship, and finding his place in the world. Through humor, heart, and stunning 
              comic-style illustrations, this story explores themes of acceptance, identity, and the 
              power of true friendship.
            </p>
          </div>

          {/* Bio Information Section - Placeholder for user content */}
          <div className="mb-8">
            <h3 className={`text-2xl font-bold mb-4 ${themeClasses.text}`}>About the Creator</h3>
            <div className={`${themeClasses.cardBg} rounded-lg p-6 border`}>
              <p className={`text-lg ${themeClasses.text} opacity-80 italic`}>
                [Bio content to be added - Please provide your bio information]
              </p>
            </div>
          </div>
...
appearances` },
              { name: "Monty", image: "/assets/5387F86A-364D-4BAA-8922-5F9B9BE65A1C.PNG", description: `The wise green friend with 
endless stories` },
              { name: "Sam", image: "/assets/IMG_6110.PNG", description: `The adventurous girl with 
blonde hair and big dreams` }
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { image: "/assets/IMG_6072.jpeg", title: "Monty Concept Art", description: "Early character design exploration" },
              { image: "/assets/IMG_6073(1).jpeg", title: "Sam Concept Art", description: "Character development sketches" },
              { image: "/assets/5BEC9A40-6F4E-4F5E-A28D-D2474441D5BD.jpeg", title: "U-GA Universe", description: "Magical world concept" }
            ].map((artwork, index) => (
              <div key={index} className={`${themeClasses.cardBg} rounded-xl p-4 border`}>
                <Image
                  src={artwork.image}
                  ...
                  className="rounded-lg w-full h-48 object-cover mb-4"
                />
                <h3 className={`text-lg font-bold text-center ${themeClasses.text} mb-2`}>{artwork.title}</h3>
                <p className={`text-sm ${themeClasses.text} opacity-80 text-center`}>{artwork.description}</p>
              </div>
            ))}
          </div>
        </section>
